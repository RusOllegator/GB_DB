...
VALUES
  ...
  ('ASUS ROG MAXIMUS X HERO', 'Материнская плата ASUS ROG MAXIMUS X HERO, Z370, Socket 1151-V2, DDR4, ATX', 19310.00, 2,NOW()),
  ('Gigabyte H310M S2H', 'Материнская плата Gigabyte H310M S2H, H310, Socket 1151-V2, DDR4, mATX', 4790.00, 2,'2019-08-17'),
  ('MSI B250M GAMING PRO', 'Материнская плата MSI B250M GAMING PRO, B250, Socket 1151, DDR4, mATX', 5060.00, 2,'2020-03-13');
 
 
DELETE FROM products p
WHERE p.created_at < (SELECT min(created_at) FROM (SELECT p2.created_at FROM products p2 ORDER BY created_at DESC LIMIT 5) T);